...
export const PrintTemplate: React.FC<PrintTemplateProps> = ({ record }) => {
  ...
  return (
    <div
      id="print-area"
      className="hidden print:block bg-white text-black font-serif text-[12pt] leading-[1.35] p-0 m-0 w-full"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="text-center w-[250px]" style={{ fontSize: '13pt' }}>
          ...
          <div className="font-bold uppercase tracking-wide">{donViCap1BacSi}</div>
          <div
      ...
      {/* PHẦN 2: I. HÀNH CHÍNH (IN ĐẬM - 12pt) */}
      ...
      {/* PHẦN 3: II. CHI PHÍ KHÁM, CHỮA BỆNH (IN ĐẬM - 12pt) */}
      <div className="mb-2.5 text-[12pt]">
        <div className="font-bold text-[12pt] mb-1.5">II. Chi phí khám, chữa bệnh</div>

        {/* Bảng viền đen border-collapse: collapse */}
        <table
          className="print-table w-full text-[11pt] border-collapse border border-black"
